 ...
 * @author Alisson
 */
@WebServlet(name = "GaragemServlet", urlPatterns = {"/Garagem"})
public class GaragemServlet extends HttpServlet {
    ...
    private RequestDispatcher listar(HttpServletRequest request, HttpServletResponse response){
        return request.getRequestDispatcher("WEB-INF/Garagem/Listar.jsp");
    }
     private RequestDispatcher detalhar(HttpServletRequest request, HttpServletResponse response){
        ...
        return request.getRequestDispatcher("WEB-INF/Garagem/Detalhar.jsp");
    }
            
    private RequestDispatcher cadastrar(HttpServletRequest request, HttpServletResponse response){
        return request.getRequestDispatcher("WEB-INF/Garagem/Cadastrar.jsp");
    }
    ...
    private RequestDispatcher inserir(HttpServletRequest request, HttpServletResponse response){
        ...
        //instanciar o Imovel
        Models.Garagem imovel = new Models.Garagem(numGaragem, metroQuadrado, preco, endereco);
        ...
        //FakeStorage.Garagem.List.add(new Models.Garagem(numGaragem, metroQuadrado, preco, endereco));
        FakeStorage.Garagem.List.add(imovel);
    ...
    private RequestDispatcher editar(HttpServletRequest request, HttpServletResponse response){
       int metroQuadrado = Integer.parseInt(request.getParameter("metroQuadrado"));
        ...
        Models.Garagem user = getById(Integer.parseInt(id));
    ...
    private RequestDispatcher remover(HttpServletRequest request, HttpServletResponse response){
        ...
        FakeStorage.Garagem.List.remove(getById(id));
        return listar(request, response);
    }
    
    private Models.Garagem getById(int id){
        Models.Garagem user = null;
