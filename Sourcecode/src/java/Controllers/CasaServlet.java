 ...
 * @author Alisson
 */
@WebServlet(name = "CasaServlet", urlPatterns = {"/Casa"})
public class CasaServlet extends HttpServlet {
    ...
    private RequestDispatcher listar(HttpServletRequest request, HttpServletResponse response){
        return request.getRequestDispatcher("WEB-INF/Casa/Listar.jsp");
    }
     private RequestDispatcher detalhar(HttpServletRequest request, HttpServletResponse response){
        ...
        return request.getRequestDispatcher("WEB-INF/Casa/Detalhar.jsp");
    }
            
    private RequestDispatcher cadastrar(HttpServletRequest request, HttpServletResponse response){
        return request.getRequestDispatcher("WEB-INF/Casa/Cadastrar.jsp");
    }
    ...
    private RequestDispatcher inserir(HttpServletRequest request, HttpServletResponse response){
        ...
        //instanciar o imovel
        Models.Casa imovel = new Models.Casa(true, numGaragem, numQuartos, numBanheiro, metroQuadrado, preco, endereco);
        ...
        //FakeStorage.Casa.List.add(new Models.Casa(true, numGaragem, numQuartos, numBanheiro, metroQuadrado, preco, endereco));
        FakeStorage.Casa.List.add(imovel);
    ...
    private RequestDispatcher editar(HttpServletRequest request, HttpServletResponse response){
       int metroQuadrado = Integer.parseInt(request.getParameter("metroQuadrado"));
        ...
        Models.Casa user = getById(Integer.parseInt(id));
    ...
    private RequestDispatcher remover(HttpServletRequest request, HttpServletResponse response){
        ...
        FakeStorage.Casa.List.remove(getById(id));
        return listar(request, response);
    }
    
    private Models.Casa getById(int id){
        Models.Casa user = null;
