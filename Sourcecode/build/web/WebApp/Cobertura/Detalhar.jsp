...
<%Models.Cobertura model = ((Models.Cobertura)request.getAttribute("Model")); %>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div style="margin: 20px auto; width: 800px">
            ...
            <form action="Cobertura">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="numBanheiro" value="<%=model.getNumBanheiros()%>" class="form-control" id="exampleInputPassword1" placeholder="Qauntidade de Banheiro">
                </div>
