...
<%Models.Kitnet model = ((Models.Kitnet)request.getAttribute("Model")); %>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div style="margin: 20px auto; width: 800px">
            ...
            <form action="Kitnet">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="andar"  value="<%=model.getAndar()%>" class="form-control" id="exampleInputPassword1" placeholder="Andar">
                </div>
                <div class="form-group">
